...
public class SellerController {
    ...
    @PostMapping()
    ApiResponse<SellerResponse> create(@ModelAttribute SellerCreationRequest request) throws IOException {
    ...
    @PatchMapping()
    ApiResponse<SellerResponse> update(@ModelAttribute SellerUpdationRequest request) throws IOException {
        return ApiResponse.<SellerResponse>builder()
                .result(sellerService.update(request))
                .build();
    }
}
